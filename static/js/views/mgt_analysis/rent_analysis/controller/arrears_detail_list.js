ampApp.controller("arrears-detail-list-controller",["$scope","$http","$rootScope","$timeout",function($scope,$http,$rootScope,$timeout){
    ...
    function bindPageEvents(){
        container.on("click",".table-group-content tr",function(e){
            e.stopPropagation();
            e.preventDefault();
